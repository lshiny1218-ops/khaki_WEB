(function() {
    ...
    // ✅ Myriad Web Pro 폰트 추가
    const myriadLink = document.createElement('link');
    myriadLink.rel = 'stylesheet';
    myriadLink.href = 'https://fonts.cdnfonts.com/css/myriad-web-pro';
    document.head.appendChild(myriadLink);

    console.log("Gowun Batang & Myriad Web Pro Fonts Loaded via JS");
})();
...
const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
    ...
    if (isMobile) {
        container.innerHTML = '<iframe src="menu_mobile.html" id="menu_mobile" style="width:900px; height:200px; border:none;"></iframe>';
